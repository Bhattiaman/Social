        ...
        <>
            ...
            <Drawer isOpen={isOpen} placement="left" onClose={onClose}>
                ...
                <DrawerContent>
                    <DrawerCloseButton />
                    <DrawerHeader>
                        <h1>Hello, I am Aman Bhatti</h1>
                    </DrawerHeader>
                    <DrawerBody>
                        <VStack alignItems={"flex-start "}>
                            <Button onClick={onClose} varient={"ghost"} colorScheme={"purple"}>
                                <Link to={"/"}>Home</Link>
                            </Button>
                            <Button onClick={onClose} varient={"ghost"} colorScheme={"purple"}>
                        ...
                        >
                            <Button onClick={onClose} top={"2.5"} colorScheme={"purple"}>
                                <Link to={"login"}>Log In</Link>
                            </Button>
                            <Button onClick={onClose} top={"2.5"} colorScheme={"purple"} variant={"outline"}>
